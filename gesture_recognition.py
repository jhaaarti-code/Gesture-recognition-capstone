def recognize_gesture(lmList, handedness):
    ...
    if fingers == [0,1,1,1,1]: return "Four fingers Up"
    if fingers == [1,1,0,0,0]: return "Zoom"
    if fingers == [1,1,1,0,0]: return "Zoom_2"
    if fingers == [0,1,1,1,0]: return "Three up"
    if fingers == [1,0,0,0,1]: return "Call"
    if fingers == [0,0,0,1,1]: return "Close Cam"
